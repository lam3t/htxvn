...
|---|---|---|---|---|
| CN-3.1.1 | Đăng nhập hệ thống | Đăng nhập bằng số điện thoại Zalo (ưu tiên) hoặc tài khoản/mật khẩu | SĐT/tài khoản, mật khẩu hoặc OTP Zalo | Vào trang chủ |
| CN-3.1.2 | Thay đổi mật khẩu | Giống CN-1.1.2 | Mật khẩu cũ/mới | Thông báo thành công |
| CN-3.1.3 | Reset mật khẩu | Giống CN-1.1.3, qua OTP số điện thoại Zalo | SĐT | OTP + đặt lại mật khẩu |
| CN-3.1.4 | Đăng xuất | Kết thúc phiên đăng nhập | — | Quay về màn hình đăng nhập |
| CN-3.1.5 | Nhận thông báo | Nhận push notification từ hệ thống (nhắc nhật ký, thông báo mới, kết quả phê duyệt...) | — | Thông báo hiển thị trên Zalo |
| CN-3.1.6 | Thông tin tài khoản | Xem/sửa thông tin cá nhân cơ bản, đổi ảnh đại diện | Họ tên, SĐT, ảnh đại diện | Hồ sơ cập nhật |
| CN-3.1.7 | Đăng ký tài khoản | Nông dân tự đăng ký làm thành viên: chọn HTX muốn tham gia, nhập thông tin cơ bản, gửi yêu cầu chờ duyệt (liên kết CN-2.3.5) | Họ tên, SĐT, CCCD, HTX muốn tham gia | Yêu cầu đăng ký ở trạng thái "Chờ duyệt" |
...
| `NguoiDung` | Tài khoản đăng nhập | n–n `NhomQuyen`; 1–1 `ThanhVien` (nếu là nông dân) |
...
| Bảo mật | Mã hóa mật khẩu (hash+salt), HTTPS toàn bộ giao tiếp, phân quyền RBAC, chống SQL Injection/XSS, giới hạn số lần đăng nhập sai |
...
- Tích hợp SMS/OTP Zalo cho xác thực (CN-1.1.3, CN-3.1.3).
...
| M3 – Zalo Mini App | Người dùng và bảo mật | 7 | CN-3.1.x |
...
**Tổng cộng: ~115 chức năng con** (đã nhóm từ 174 dòng dữ liệu gốc trong file Excel, loại trừ các dòng tiêu đề nhóm).

---

*Hết tài liệu SRS phiên bản 1.0. Tài liệu cần được rà soát cùng Ban quản trị 3 HTX thí điểm và Sở NN&PTNT Hưng Yên trước khi chuyển sang giai đoạn thiết kế chi tiết (database design, wireframe/UI design, API design).*
